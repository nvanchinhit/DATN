      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-xl shadow-lg p-6 md:p-10 border border-blue-200">
          ...
          <div className="flex mb-6">
            <button
              type="button"
              className={`flex-1 py-2 text-center rounded-l-md font-medium ${mode === 'self' ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700'}`}
              onClick={() => setMode('self')}
            >Đặt cho bản thân</button>
            <button
              type="button"
              className={`flex-1 py-2 text-center rounded-r-md font-medium ${mode === 'other' ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700'}`}
              onClick={() => setMode('other')}
            >Đặt cho người thân</button>
          </div>
